...
// 发送邮件
function sendEmail(text, subject='签到结果',emailList) {
  let currentData = getCurrentData()
  // var client = new SMTPClient({
  //     user: "992007307@qq.com", // 你的QQ用户
  //     password: "szqauyrbnrwpbcbd", // 这里是上面生成的授权码，不是QQ密码
  ...
  /*client.send({
      text: text, //邮件内容
      from: "992007307@qq.com", //你的邮箱号
      to: "1696674002@qq.com", //发送给谁的
